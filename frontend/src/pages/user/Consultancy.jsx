	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-violet-100 font-poppins py-10 px-2">
			<Helmet>
				...
				/>
				<meta name="keywords" content="consultancy, research, ziksir, request" />
				...
				<div className="flex-1 bg-white rounded-2xl shadow-lg border border-blue-100 p-8 mb-8 md:mb-0">
					<div className="text-center mb-8">
						...
						<p className="text-lg text-muted-foreground font-open-sans">
							Unlock your research potential with personalized consultancy from top
							experts. Whether you're a startup, industry, or academic, Ziksir
							connects you to the right minds for every challenge.
						</p>
					</div>
